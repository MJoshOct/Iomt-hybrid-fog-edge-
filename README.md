...
Please note:
We have not implemented hardware but simulated the sensor behaviour. Docker was setup but not implemented as its use-case was not justified for goals of this project. Thus servers were made to run in local machines only. Regardless of presence of Remote deployment files.
